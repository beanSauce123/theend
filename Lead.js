...
import leadModel from './assets/lead.glb'

export default function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials } = useGLTF(leadModel)
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh geometry={nodes.Right_atrium001.geometry} material={materials['Trapezius.001']} position={[0, 0.08, 0]} rotation={[Math.PI / 2, 0, 0]} scale={1.03} />
      ...
      <mesh geometry={nodes.Vert.geometry} material={nodes.Vert.material} position={[0.07, 0.2, -0.03]} />
      <mesh geometry={nodes.Anterior_papillary_muscle_of_right_ventricle001.geometry} material={materials['Trapezius.001']} position={[0, 0.08, 0]} scale={1.03} />
      <mesh geometry={nodes.Inferior_papillary_muscle_of_right_ventricle001.geometry} material={materials['Trapezius.001']} position={[0, 0.08, 0]} scale={1.03} />
      <mesh geometry={nodes.Septal_papillary_muscle_of_right_ventricle001.geometry} material={materials['Trapezius.001']} position={[0, 0.08, 0]} scale={1.03} />
    </group>
  )
}

useGLTF.preload('/lead.glb')
